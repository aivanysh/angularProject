...
@Component({
  ...
  styleUrls: ["./achieved-intinbounds.component.scss"]
})
export class AchievedIntInboundComponent implements OnInit {
  ...
  getPage(page: number): void {
    ...
    this.getCorrespondence("IntInbArc", start, end, page, this.SearchFilterData);
  }
