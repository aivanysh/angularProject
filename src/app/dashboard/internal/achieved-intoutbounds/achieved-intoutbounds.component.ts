...
@Component({
  ...
  styleUrls: ["./achieved-intoutbounds.component.scss"]
})
export class AchievedIntOutboundComponent implements OnInit {
...
if (correspondData) {this.setPerformerPermission(correspondData)};
  ...
  getPage(page: number): void {
    ...
    this.getCorrespondence("IntOutArc", start, end, page, this.SearchFilterData);
  }
