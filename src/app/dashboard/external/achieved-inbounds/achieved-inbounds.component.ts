...
@Component({
  ...
  styleUrls: ["./achieved-inbounds.component.scss"]
})
export class AchievedInboundsComponent implements OnInit {
  ...
  getPage(page: number): void {
    ...
    this.getCorrespondence("ExtInbArc", start, end, page, this.SearchFilterData);
  }
...
/*   selectionNewInboxAll() {
  ...
  showWorkflowAudit(VolumeID: number) {
    var WFAuditWindow;
    var winFeatures = 'width=1600,height=800,resizable,scrollbars=yes';
    var url = '?func=ll&objId=249044&objAction=RunReport&inputlabel1=' + VolumeID + '&prompting=done';
