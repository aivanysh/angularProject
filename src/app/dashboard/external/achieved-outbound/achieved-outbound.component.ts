...
@Component({
  ...
  styleUrls: ["./achieved-outbound.component.scss"]
})
export class AchievedOutboundComponent implements OnInit {
  ...
  constructor(private correspondenceService: CorrespondenceService, private route: ActivatedRoute,
    private router: Router, public dialogU: MatDialog) { }
...
/*   selectionNewInboxAll() {
  ...
  setAttributeValue(AttributeType, Value) {
